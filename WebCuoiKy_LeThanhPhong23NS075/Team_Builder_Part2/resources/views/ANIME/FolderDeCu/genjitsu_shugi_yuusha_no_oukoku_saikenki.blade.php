    ...
    <head>
        ...
        <title>Xem phim Genjitsu Shugi Yuusha no Oukoku Saikenki</title>
                            ...
                            <div class="row">
                                <div class="col-6 movie-detail">
                                    <h1 class="movie-title">
                                        <span class="title-1" itemprop="name">Genjitsu Shugi Yuusha no Oukoku Saikenki</span>
                                        <span class="title-2" itemprop="name">現実主義勇者の王国再建記 | How a Realist Hero Rebuilt the Kingdom</span>
                                        <span class="title-year"> (2024)</span>
                                    </h1>
                                    <div class="movie-meta-info">
                                        <dl class="movie-dl">
                                            <dt class="movie-dt">Số tập: </dt>
                                            <dd class="movie-dd"><a href="">13/13</a></dd><br>
                                            <dt class="movie-dt">Thể loại: </dt>
                                            <dd class="movie-dd dd-cat"><a href="?">Fantasy</a></dd><br>
                                            <dt class="movie-dt">Nhà sản xuất: </dt>
                                            <dd class="movie-dd"><a href="danh-sach/tv-series/1.html">J.C. Staff</a></dd><br>
                                            <dt class="movie-dt">Ngày phát hành: </dt>
                                            <dd class="movie-dd"><a href="?">2021-07-04</a></dd><br>
                                ...
                                <div class="col-6 movie-image">
                                    <div class="movie-l-img"><img itemprop="image" alt="" src="uploads/images-anime/1732795388_gsy.jpg" id="style-lOE6n" class="style-lOE6n">
