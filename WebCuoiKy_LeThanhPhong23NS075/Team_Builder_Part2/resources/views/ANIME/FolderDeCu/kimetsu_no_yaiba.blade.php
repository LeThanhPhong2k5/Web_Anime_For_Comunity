    ...
    <head>
        ...
        <title>Xem phim Kimetsu No Yaiba</title>
                            ...
                            <div class="row">
                                <div class="col-6 movie-detail">
                                    <h1 class="movie-title">
                                        <span class="title-1" itemprop="name">Kimetsu No Yaiba</span>
                                        <span class="title-2" itemprop="name">鬼滅の刃  | Demon Slayer: Kimetsu no Yaiba</span>
                                        <span class="title-year"> (2024)</span>
                                    </h1>
                                    <div class="movie-meta-info">
                                        <dl class="movie-dl">
                                            <dt class="movie-dt">Số tập: </dt>
                                            <dd class="movie-dd"><a href="">26/26</a></dd><br>
                                            <dt class="movie-dt">Thể loại: </dt>
                                            <dd class="movie-dd dd-cat"><a href="?">Supernatural</a></dd><br>
                                            <dt class="movie-dt">Nhà sản xuất: </dt>
                                            <dd class="movie-dd"><a href="danh-sach/tv-series/1.html">Ufotable</a></dd><br>
                                            <dt class="movie-dt">Ngày phát hành: </dt>
                                            <dd class="movie-dd"><a href="?">2019-04-06</a></dd><br>
                                ...
                                <div class="col-6 movie-image">
                                    <div class="movie-l-img"><img itemprop="image" alt="" src="uploads/images-anime/1732794784_kny.jpg" id="style-lOE6n" class="style-lOE6n">
