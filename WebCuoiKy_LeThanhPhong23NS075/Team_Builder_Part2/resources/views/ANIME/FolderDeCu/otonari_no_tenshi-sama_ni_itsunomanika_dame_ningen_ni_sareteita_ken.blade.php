    ...
    <head>
        ...
        <title>Xem phim Otonari no Tenshi-sama ni Itsunomanika Dame Ningen ni Sareteita Ken</title>
                            ...
                            <div class="row">
                                <div class="col-6 movie-detail">
                                    <h1 class="movie-title">
                                        <span class="title-1" itemprop="name">Otonari no Tenshi-sama ni Itsunomanika Dame Ningen ni Sareteita Ken</span>
                                        <span class="title-2" itemprop="name">お隣の天使様にいつの間にか駄目人間にされていた件 |  The Angel Next Door Spoils Me Rotten</span>
                                    </h1>
                                    <div class="movie-meta-info">
                                        <dl class="movie-dl">
                                            <dt class="movie-dt">Số tập: </dt>
                                            <dd class="movie-dd"><a href="">12/12</a></dd><br>
                                            <dt class="movie-dt">Thể loại: </dt>
                                            <dd class="movie-dd dd-cat"><a href="?">Romance</a></dd><br>
                                            <dt class="movie-dt">Nhà sản xuất: </dt>
                                            <dd class="movie-dd"><a href="danh-sach/tv-series/1.html">Project No.9</a></dd><br>
                                            <dt class="movie-dt">Ngày phát hành: </dt>
                                            <dd class="movie-dd"><a href="?">2023-01-07</a></dd><br>
                                            <dt class="movie-dt">Trạng thái</dt>
                                            <dd class="movie-dd imdb">Đã hoàn thành</dd><br>
                                            </dd><br>
                                ...
                                <div class="col-6 movie-image">
                                    <div class="movie-l-img"><img itemprop="image" alt="" src="uploads/images-anime/1732795752_ont.jpg" id="style-lOE6n" class="style-lOE6n">
