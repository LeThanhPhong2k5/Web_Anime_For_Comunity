    ...
    <head>
        ...
        <title>Xem phim BLUE ARCHIVE THE ANIMATION</title>
                            ...
                            <div class="row">
                                <div class="col-6 movie-detail">
                                    <h1 class="movie-title">
                                        <span class="title-1" itemprop="name">BLUE ARCHIVE THE ANIMATION</span>
                                        <span class="title-2" itemprop="name">ブルーアーカイブ The Animation</span>
                                    ...
                                    <div class="movie-meta-info">
                                        <dl class="movie-dl">
                                            ...
                                            <dd class="movie-dd"><a href="danh-sach/tv-series/1.html">Madhouse</a></dd><br>
                                            <dt class="movie-dt">Ngày phát hành: </dt>
                                            <dd class="movie-dd"><a href="?">2024-04-07</a></dd><br>
                                ...
                                <div class="col-6 movie-image">
                                    <div class="movie-l-img"><img itemprop="image" alt="" src="uploads/images-anime/1732784101_blue_archive_the_animation.jpg" id="style-lOE6n" class="style-lOE6n">
