    ...
    <head>
        ...
        <title>Xem phim Kage no Jitsuryokusha ni Naritakute!</title>
                            ...
                            <div class="row">
                                <div class="col-6 movie-detail">
                                    <h1 class="movie-title">
                                        <span class="title-1" itemprop="name">Kage no Jitsuryokusha ni Naritakute!</span>
                                        <span class="title-2" itemprop="name">陰の実力者になりたくて！ | The Eminence in Shadow</span>
                                        <span class="title-year"> (2024)</span>
                                    </h1>
                                    <div class="movie-meta-info">
                                        <dl class="movie-dl">
                                            <dt class="movie-dt">Số tập: </dt>
                                            <dd class="movie-dd"><a href="">20/20</a></dd><br>
                                            ...
                                            <dd class="movie-dd"><a href="?">2022-10-05</a></dd><br>
                                ...
                                <div class="col-6 movie-image">
                                    <div class="movie-l-img"><img itemprop="image" alt="" src="uploads/images-anime/1732791176_kage_no_jitsuryokusha_ni_naritakute.jpg" id="style-lOE6n" class="style-lOE6n">
